...
$dataDir = $component . '/administrator/components/com_jcbinout/data';
...
foreach ($files as $file) {
    ...
    $dataPath = 'administrator/components/com_jcbinout/data/';

    if (str_starts_with($local, $dataPath . 'derived/')) {
        continue;
    }

    if (
        str_starts_with($local, $dataPath)
        && !str_starts_with($local, $dataPath . 'hello-world/')
